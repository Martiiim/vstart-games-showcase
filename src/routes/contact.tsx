  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
        <h1 className="font-display text-4xl text-foreground sm:text-5xl">Get in <span className="text-primary text-glow">Touch</span></h1>
        <p className="mt-4 max-w-2xl text-muted-foreground">Got a question, a fan letter, or a business inquiry? We'd love to hear from you.</p>
